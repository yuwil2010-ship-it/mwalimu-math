    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="mt-5 text-center space-y-3">
        <p className="text-xs text-gray-500">
          Don&apos;t have an account? <Link href="/" className="text-[#4F5AAE] font-semibold hover:underline">Click here</Link>
        </p>
        <Link href="/notes" className="inline-flex items-center gap-1.5 text-xs text-[#4F5AAE] font-medium hover:underline">
